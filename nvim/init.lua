...
vim.api.nvim_set_option('scrolloff', 12)
...
-- Gitsigns
vim.api.nvim_set_keymap('', '<leader>gb', ':Gitsigns blame_line<CR>', opts)
...
-- Git Files
vim.api.nvim_set_keymap('n', '<leader>sg', '<cmd>lua require"mappings".git_files()<cr>', opts)

-- Git Buffer Files
-- vim.api.nvim_set_keymap('n', '<leader>gF', '<cmd>lua require"mappings".buffer_git_files()<cr>', opts)

-- Find Files
vim.api.nvim_set_keymap('n', '<leader>sa', '<cmd>lua require"mappings".search_all_files()<cr>', opts)

-- Search live grep
vim.api.nvim_set_keymap('n', '<leader>ss', '<cmd>lua require"mappings".live_grep()<cr>', opts)

-- File Browser
vim.api.nvim_set_keymap('n', '<leader>st', '<cmd>lua require"mappings".file_browser()<cr>', opts)

-- Color Scheme
vim.api.nvim_set_keymap('n', '<leader>cs', '<cmd>Telescope colorscheme<cr>', opts)

-- Current buffer fuzzy find
vim.api.nvim_set_keymap('n', '<leader>sf', '<cmd>lua require"mappings".curbuf()<cr>', opts)
